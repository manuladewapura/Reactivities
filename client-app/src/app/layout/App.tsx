...
const App = () => {
  ...
  const selectedActivityHandler = (id: string | null) => {
    if (id === null) {
  ...
  return (
    <Fragment>
      <NavBar openCreatForm={openCreatFormHanler} />
      <Container style={{ marginTop: '7em' }}>
        {/* <ActivityDashboard activities={activities} selectActivity={selectedActivityHandler} selectedActivity={selectedActivity!} /> */}
